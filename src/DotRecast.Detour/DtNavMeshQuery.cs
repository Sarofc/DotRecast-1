...
namespace DotRecast.Detour
{
     ...
     */
        ...
        protected DtStatus AppendVertex(Vector3 pos, int flags, long refs, Span<DtStraightPath> straightPath, ref int straightPathCount, int maxStraightPath)
        {
        ...
        public DtStatus Raycast(long startRef, Vector3 startPos, Vector3 endPos,
            IDtQueryFilter filter,
            out float t, out Vector3 hitNormal, ref List<long> path)
        {
