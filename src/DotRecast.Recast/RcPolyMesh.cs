...
namespace DotRecast.Recast
{
    ...
    {
        public ushort[] verts; // The mesh vertices. [Form: (x, y, z) coordinates * #nverts]
        public ushort[] polys; // Polygon and neighbor data. [Length: #maxpolys * 2 * #nvp]
        public ushort[] regs; // The region id assigned to each polygon. [Length: #maxpolys]
        public ushort[] flags; // The user defined flags for each polygon. [Length: #maxpolys]
        public byte[] areas; // The area id assigned to each polygon. [Length: #maxpolys]
