...
public static class GizmoRenderer
{
    ...
    public static void RenderTrimesh(RecastDebugDraw debugDraw, RcTrimeshGizmo trimesh)
    {
        ...
        {
            Vector3 v0 = RcVecUtils.Create(trimesh.vertices, 3 * trimesh.triangles[i]);
            Vector3 v1 = RcVecUtils.Create(trimesh.vertices, 3 * trimesh.triangles[i + 1]);
            Vector3 v2 = RcVecUtils.Create(trimesh.vertices, 3 * trimesh.triangles[i + 2]);
